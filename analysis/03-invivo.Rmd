...
## **Original Figures**
```{r, echo=FALSE, out.width='100%', fig.align='left', fig.cap=''}
knitr::include_graphics("../docs/assets/original_fig/31744829_KwokKinWong_CancerDiscov_2019_KP.overview.png", error = FALSE)
```
```{r, echo=FALSE, out.width='85%', fig.align='left', fig.cap=''}
knitr::include_graphics("../docs/assets/original_fig/31744829_KwokKinWong_CancerDiscov_2019_KP-WT_aPD1.png", error = FALSE)
```
...
### Processed - Rank Plot
```{r, echo=FALSE, out.width='75%', fig.align='left', fig.cap=''}
knitr::include_graphics('../docs/assets/median_scaled_QC/RankPlot/31744829_KwokKinWong_CancerDiscov_2019_KP_aPD1_Invivo_LUAD.png', error = FALSE)
```
...
### Raw - Rank Plot
```{r, echo=FALSE, out.width='75%', fig.align='left', fig.cap=''}
knitr::include_graphics('../docs/assets/RRA_QC/RankPlot/31744829_KwokKinWong_CancerDiscov_2019_KP-WT_aPD1_Invivo_LUAD.png', error = FALSE)
```
...
### Raw - Volcano Plot
```{r, echo=FALSE, out.width='75%', fig.align='left', fig.cap=''}
knitr::include_graphics('../docs/assets/RRA_QC/VolcanoPlot/31744829_KwokKinWong_CancerDiscov_2019_KP-WT_aPD1_Invivo_LUAD.png', error = FALSE)
```
...
### Processed - Rank Plot
```{r, echo=FALSE, out.width='75%', fig.align='left', fig.cap=''}
knitr::include_graphics('../docs/assets/median_scaled_QC/RankPlot/31744829_KwokKinWong_CancerDiscov_2019_KP.koRag1_aPD1_Invivo_LUAD.png', error = FALSE)
```
...
### Raw - Rank Plot
```{r, echo=FALSE, out.width='75%', fig.align='left', fig.cap=''}
knitr::include_graphics('../docs/assets/RRA_QC/RankPlot/31744829_KwokKinWong_CancerDiscov_2019_KP-koRag1_aPD1_Invivo_LUAD.png', error = FALSE)
```
...
### Raw - Volcano Plot
```{r, echo=FALSE, out.width='75%', fig.align='left', fig.cap=''}
knitr::include_graphics('../docs/assets/RRA_QC/VolcanoPlot/31744829_KwokKinWong_CancerDiscov_2019_KP-koRag1_aPD1_Invivo_LUAD.png', error = FALSE)
```
...
## **Original Figures**
```{r, echo=FALSE, out.width='85%', fig.align='left', fig.cap=''}
knitr::include_graphics("../docs/assets/original_fig/31827283_HongboChi_Nature_2019_OT-I_B16F10.png", error = FALSE)
```
...
### Processed - Rank Plot
```{r, echo=FALSE, out.width='75%', fig.align='left', fig.cap=''}
knitr::include_graphics('../docs/assets/median_scaled_QC/RankPlot/31827283_HongboChi_Nature_2019_OT-I_B16F10_Invivo_CD8T.png', error = FALSE)
```
...
### Raw - Rank Plot
```{r, echo=FALSE, out.width='75%', fig.align='left', fig.cap=''}
knitr::include_graphics('../docs/assets/RRA_QC/RankPlot/31827283_HongboChi_Nature_2019_OT-I_B16F10_Invivo_CD8T.png', error = FALSE)
```
...
### Raw - Volcano Plot
```{r, echo=FALSE, out.width='75%', fig.align='left', fig.cap=''}
knitr::include_graphics('../docs/assets/RRA_QC/VolcanoPlot/31827283_HongboChi_Nature_2019_OT-I_B16F10_Invivo_CD8T.png', error = FALSE)
```
...
## **Original Figures**
```{r, echo=FALSE, out.width='85%', fig.align='left', fig.cap=''}
knitr::include_graphics("../docs/assets/original_fig/31827283_HongboChi_Nature_2019_OT-I.koRegnase-1_B16F10.png", error = FALSE)
```
...
### Processed - Rank Plot
```{r, echo=FALSE, out.width='75%', fig.align='left', fig.cap=''}
knitr::include_graphics('../docs/assets/median_scaled_QC/RankPlot/31827283_HongboChi_Nature_2019_OT-I.koRegnase-1_B16F10_Invivo_CD8T.png', error = FALSE)
```
...
### Raw - Rank Plot
```{r, echo=FALSE, out.width='75%', fig.align='left', fig.cap=''}
knitr::include_graphics('../docs/assets/RRA_QC/RankPlot/31827283_HongboChi_Nature_2019_OT-I.koRegnase-1_B16F10_Invivo_CD8T.png', error = FALSE)
```
...
### Raw - Volcano Plot
```{r, echo=FALSE, out.width='75%', fig.align='left', fig.cap=''}
knitr::include_graphics('../docs/assets/RRA_QC/VolcanoPlot/31827283_HongboChi_Nature_2019_OT-I.koRegnase-1_B16F10_Invivo_CD8T.png', error = FALSE)
```
